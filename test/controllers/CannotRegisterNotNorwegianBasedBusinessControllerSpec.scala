...
class CannotRegisterNotNorwegianBasedBusinessControllerSpec extends SpecBase {
  ...
  "CannotRegisterNotNorwegianBasedBusiness Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, routes.CannotRegisterNotNorwegianBasedBusinessController.onPageLoad(waypoints).url)
