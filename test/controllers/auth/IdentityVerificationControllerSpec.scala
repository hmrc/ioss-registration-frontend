...
import models.iv.IdentityVerificationResult.{FailedIdentityVerification, FailedMatching, Incomplete, InsufficientEvidence, LockedOut, PrecondFailed, Success, TechnicalIssue, TimeOut, UserAborted}
  ...
  "IdentityVerification Controller" - {
    ...
    ".identityError" - {
      ...
      "must return OK and correct view" in {
        ...
        running(application) {
          val request = FakeRequest(GET, authRoutes.IdentityVerificationController.identityError(continueUrl).url)
    ...
    ".handleIvFailure" - {
      ...
      "must redirect to the continue URL when the result was Success" in {
        ...
        running(application) {
          val request = FakeRequest(GET, authRoutes.IdentityVerificationController.handleIvFailure(continueUrl, journeyId).url)
          val result = route(application, request).value
      ...
      "must redirect to the Incomplete page when the result was Incomplete" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.incomplete().url
        }
      }
      ...
      "must redirect to the Failed Matching page when the result was FailedMatching" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.failedMatching(continueUrl).url
        }
      }
      ...
      "must redirect to the Failed page when the result was Failed Identity Verification" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.failed(continueUrl).url
        }
      }
      ...
      "must redirect to the Not Enough Evidence Sources page when the result was Insufficient Evidence and all evidence sources are off" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.notEnoughEvidenceSources().url
        }
      }
      ...
      "must redirect to the Insufficient Evidence page when the result was Insufficient Evidence and some evidence sources are on" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.insufficientEvidence().url
        }
      }
      ...
      "must redirect to the Locked Out page when the result was Locked Out" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.lockedOut().url
        }
      }
      ...
      "must redirect to the User Aborted page when the result was User Aborted" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.userAborted(continueUrl).url
        }
      }
      ...
      "must redirect to the Timeout page when the result was Timeout" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.timeout().url
        }
      }
      ...
      "must redirect to the Technical Issue page when the result was Technical Issue" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.technicalIssue().url
        }
      }
      ...
      "must redirect to the Precondition Failed page when the result was Precondition Failed" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.preconditionFailed().url
        }
      }
      ...
      "must redirect to the IvReturnController error page when the result was None" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IvReturnController.error().url
        }
      }
      ...
      "must redirect to the IdentityVerificationController identityError page when the journey id is missing" in {
        ...
        running(application) {
          ...
          status(result) mustBe SEE_OTHER
          redirectLocation(result).value mustBe routes.IdentityVerificationController.identityError(continueUrl).url
        }
      }
