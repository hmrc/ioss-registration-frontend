    ...
    "must deserialise valid values" in {
      ...
      forAll(gen) {
        registrationType =>
          ...
          JsString(registrationType.toString).validate[RegistrationType].asOpt.value mustBe registrationType
      }
    }
    ...
    "must fail to deserialise invalid values" in {
      ...
      forAll(gen) {
        invalidValue =>
          ...
          JsString(invalidValue).validate[RegistrationType] mustBe JsError("error.invalid")
      }
    }
    ...
    "must serialise" in {
      ...
      forAll(gen) {
        registrationType =>
          ...
          Json.toJson(registrationType) mustBe JsString(registrationType.toString)
      }
    }
  }
}
