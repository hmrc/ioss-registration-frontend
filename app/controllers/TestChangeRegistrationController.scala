...
import pages.{AmendYourAnswersPage, CheckYourAnswersPage, EmptyWaypoints, Waypoint}
...
class TestChangeRegistrationController @Inject()(
                                       override val messagesApi: MessagesApi,
                                       cc: AuthenticatedControllerComponents,
                                       view: TestChangeRegistrationView
